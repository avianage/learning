...
| **[Flex Layout](./problems/2-flex-layout)** | Building layouts with Flexbox | Flexbox |
| **[Grid Layout](./problems/3-grid-layout)** | Building layouts with CSS Grid | CSS Grid |
| **[Complicated Grid](./problems/4-more-complicated-grid)** | Advanced grid stuctures | CSS Grid |
| **[VSCode Bottom Bar](./problems/5-vscode-bottombar)** | Replicating a specific UI component | Real-world UI |
| **[VSCode Landing Page](./problems/6-vs-code-landing-page)** | Replicating a full page layout | Live Page Clone |
